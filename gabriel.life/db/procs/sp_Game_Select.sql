...
DROP PROCEDURE IF EXISTS `mylife_static`.`dsp_Quests_sel` GO
CREATE DEFINER=`mylife_game`@`%` PROCEDURE `mylife_static`.`dsp_Quests_sel`(kvQuestID int)
BEGIN
...
--
-- Table: tbl_Quest_Triggers
--

DROP PROCEDURE IF EXISTS `mylife_static`.`dsp_Quest_Trigger_lst` GO
CREATE DEFINER=`mylife_game`@`%` PROCEDURE `mylife_static`.`dsp_Quest_Trigger_lst`()
BEGIN

	SELECT id, TriggerType, ActionTrigger, QuestID, StepID, StepNumber
	FROM mylife_static.tbl_Quest_Step_Trigger;
	
END;
GO

DROP PROCEDURE IF EXISTS `mylife_static`.`dsp_Quest_Trigger_sel` GO
CREATE DEFINER=`mylife_game`@`%` PROCEDURE `mylife_static`.`dsp_Quest_Trigger_sel`(
kvType int,
kvAction int)
BEGIN
	...
	SELECT id, TriggerType, ActionTrigger, QuestID, StepID, StepNumber
	FROM mylife_static.tbl_Quest_Step_Trigger
	WHERE TriggerType = kvType and ActionTrigger = kvAction
...
DROP PROCEDURE IF EXISTS `mylife_static`.`dsp_Game_init` GO
...
DROP PROCEDURE IF EXISTS `mylife_static`.`dsp_config_getvalue` GO
